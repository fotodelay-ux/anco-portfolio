/* projects-data.js — Work 페이지 프로젝트 콘텐츠
   ─────────────────────────────────────────────
   여기 있는 PROJECTS 배열만 수정하면 새 프로젝트를 추가하거나
   기존 프로젝트 내용(제목/설명/이미지/블록)을 바꿀 수 있습니다.
   site-app.jsx의 화면 로직은 건드릴 필요 없습니다.

   각 프로젝트 항목:
   - id, title, subtitleKo, year, client, workType, outputs, img, big
...
const PROJECTS = [
    ...
    "blocks": [
      {
        "type": "images",
        "src": [
          "site-img/Project_2_lifetime_3.png"
        ],
        "cols": 1,
        "ratio": "auto",
        "fit": "cover"
      ...
      },
      {
        "type": "images",
        "src": [
          "site-img/Project_2_lifetime_5.png"
        ],
        "cols": 1,
        "ratio": "16/9",
        "fit": "cover"
      ...
      },
      {
        "type": "images",
        "src": [
          "site-img/Project_2_lifetime_12.png",
          "site-img/Project_2_lifetime_13.png",
          "site-img/Project_2_lifetime_14.png"
        ],
        "cols": 1,
        "ratio": "16/9",
        "fit": "cover"
      ...
      }, 
      {
        "type": "images",
        "src": [
          "site-img/Project_2_lifetime_15.png"
        ],
        "cols": 1,
        "ratio": "16/9",
        "fit": "cover"
  ...
  },
  {
    ...
    "blocks": [
      ...
      },
      {
        "type": "images",
        "src": [
          "site-img/Project_4_logo.png",
          "site-img/Project_4_logo2.png"
        ],
        "cols": 2,
        "ratio": "16/9",
        "fit": "cover",
      ...
      },
      {
        "type": "images",
        "src": [
          "site-img/Project_4_poster2.jpg",
          "site-img/Project_4_sns.jpg"
        ],
        "cols": 2,
        "ratio": "auto",
        "fit": "contain"
      },
      {
        "type": "images",
        "src": [
          "site-img/Project_4_Thumbnail.png",
          "site-img/Project_4_poster3.jpg"
        ],
        "cols": 2,
        "ratio": "16/9",
        "fit": "cover"
      },
      {
        "type": "images",
        "src": [
          "site-img/Project_4_endpage.mp4",
          "site-img/Project_4_bumper.mp4"
        ],
        "cols": 1,
        "ratio": "auto",
        "fit": "contain"
  ...
  },
  {
    ...
    "descKo": "신인 아티스트 '엔싸인(n.SSign)'의 도쿄 아레나 입성을 위한 챌린지 리얼리티 <Project 10K>의 비주얼 아이덴티티 및 패키지 시스템을 총괄했습니다. 총 5번의 게릴라 공연을 통해 1만 명의 관객을 동원해야 하는 거대한 퀘스트 과정을 시각화하는 프로젝트입니다. 단순한 웹 예능 로고 제작을 넘어, 아티스트가 현실의 미션을 격파하고 자신들만의 세계관을 확장해 나가는 역동적인 구조를 설계하는 데 집중했습니다.",
    "blocks": [
      {
        "type": "section",
        "label": "Project Overview",
      ...
      },
      {
        "type": "images",
        "src": [
          "site-img/Project_5_bumper_2.mp4"
        ],
        "cols": 1,
        "ratio": "auto",
        "fit": "contain"
      },
      {
        "type": "images",
        "src": [
          "site-img/Project_5_endpage.png"
        ],
        "cols": 1,
        "ratio": "16/9",
        "fit": "cover"
